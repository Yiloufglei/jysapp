<!-- 
 ...
 -->
<template>
	<div class="binaryOptionAccount overflowPatible_box">
		...
		<div class="actionBar flexC_S">
			<div v-if="indexSelectItem.swich_trans === 1" class="actionBa_list t_c"
				@click="routerPath(`/capitalTransfer?account=qnum&coin_name=${indexSelectItem.coin_name}`)">
				<img src="@/assets/imgs/transfer_text.png" alt="" />
				<p  class="">划转</p>
			</div>
			<div class="actionBa_list t_c"  @click="routerPath('/binaryOption')">
				<img src="@/assets/imgs/coinsTrade-1.png" alt="" />
				<p  class="color_b">期权交易</p>
			</div>
		</div>
        <van-action-sheet
            v-model="visible"
